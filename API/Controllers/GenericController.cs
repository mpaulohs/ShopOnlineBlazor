...
namespace ShopOnline.API.Controllers
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private readonly ILogger<GenericController<TEntity, TKey>> _logger;

        public GenericController(IRepository<TEntity, TKey> repository, ILogger<GenericController<TEntity, TKey>> loger)
        {
        ...
        [HttpPut("{id:Guid}")]
        public async Task<ActionResult> Put([FromRoute] TKey id, [FromBody] TEntity entity)
        {
            try
            {
        ...
        [HttpPatch("{id:Guid}")]
        public async Task<ActionResult> Patch([FromRoute] TKey id, [FromBody] JsonPatchDocument entity)
        {
            try
            {
                if (id == null || entity == null)
        ...
        [HttpDelete("{id:Guid}")]
        public async Task<ActionResult> Delete([FromRoute] TKey id)
        {
            try
            {
                if (id == null)
